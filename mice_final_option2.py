...
for i in range(l-10):
    ...
    #     else:
    #         COM_action[i,2,0]=1
    COM_action[i]=5*data[i+1]+3*data[i+2]+2*data[i+3]-10*data[i]
...
def _update_plot(i, fig, scat):
    ...
    plt.plot(datai[0:2,0], datai[0:2,1], 'ro-')#[datai[0,0],datai[0,1]],[datai[1,0],data[1,1]])
