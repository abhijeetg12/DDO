...
class TFModel(object):
    ...
    def train(self, opt, X, iterations, vqiterations=100, vqbatchsize=25):
        ...
        for it in range(iterations):
            ...
            cLoss_vec.append(np.mean(self.sess.run(self.policy_networks[0]['wlprob'],batch)))
            tLoss_vec.append(np.mean(self.sess.run(self.transition_networks[0]['wlprob'],batch)))
